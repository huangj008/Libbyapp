...
export function SurveyModal({ onClose }: SurveyModalProps) {
  ...
  if (isSuccess) {
    return (
      <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
        ...
        <div className="relative w-full max-w-md bg-[#111] rounded-2xl flex flex-col items-center justify-center p-8 animate-in zoom-in-95 duration-300 border border-[#222] shadow-2xl">
            ...
            <button 
            onClick={onClose}
            className="bg-white text-black font-bold py-3 px-8 rounded-full hover:bg-gray-200 transition-colors w-full sm:w-auto"
            >
            Return to Library
            </button>
        </div>
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center sm:p-6">
        ...
        <div className="relative w-full h-full sm:h-auto sm:max-h-[85vh] sm:max-w-md bg-[#111] flex flex-col animate-in slide-in-from-bottom duration-300 sm:rounded-2xl border-x sm:border border-[#222] shadow-2xl overflow-hidden">
        {/* Header */}
        ...
        {/* Progress Bar */}
        <div className="h-1 bg-[#222] w-full shrink-0">
            <div 
